...
if ($AppCatalogAdmin) { 
    try {
        ...
        try { # Test that user can write values to the App Catalog
            Set-PnPStorageEntity -Key MicrosoftCustomLearningCdn -Value "https://if-blueprint.github.io/custom-learning-office-365-de-de/v2/" -Description "CDN source for Microsoft Content" -ErrorAction Stop 
            } catch {
